...
#> 
#> The model's R-squared is  0.1426 
#> The  5  most prevalent topics are:
#> # A tibble: 10 x 4
#>   topic prevalence coherence top_terms                     
#>   <dbl>      <dbl>     <dbl> <chr>                         
#> 1     5       14.6    0.148  research, program, cancer, ...
#> 2     4       12.3    0.208  cns, cell, cells, ...         
#> 3     9       12.2    0.0557 hiv, health, diabetes, ...    
#> 4     7       11.4    0.175  cancer, cells, treatment, ... 
#> 5     6       10.3    0.126  risk, sud, clinical, ...      
#> # … with 5 more rows
#> 
#> The  5  most coherent topics are:
#> # A tibble: 10 x 4
#>   topic prevalence coherence top_terms                              
#>   <dbl>      <dbl>     <dbl> <chr>                                  
#> 1     8       6.66     0.423 injury, function, cmybp, ...           
#> 2    10       6.82     0.339 mitochondrial, studies, plasticity, ...
#> 3     4      12.3      0.208 cns, cell, cells, ...                  
#> 4     7      11.4      0.175 cancer, cells, treatment, ...          
#> 5     5      14.6      0.148 research, program, cancer, ...         
#> # … with 5 more rows
