...
#> 
#> The model's R-squared is  0.1504 
#> The  5  most prevalent topics are:
#> # A tibble: 10 x 4
#>   topic prevalence coherence top_terms                     
#>   <dbl>      <dbl>     <dbl> <chr>                         
#> 1     5       13.8    0.148  research, program, cancer, ...
#> 2     9       12.7    0.0803 diabetes, data, health, ...   
#> 3     6       11.5    0.163  risk, factors, clinical, ...  
#> 4     2       10.8    0.0643 core, research, response, ... 
#> 5     7       10.1    0.212  cancer, treatment, tumor, ... 
#> # … with 5 more rows
#> 
#> The  5  most coherent topics are:
#> # A tibble: 10 x 4
#>   topic prevalence coherence top_terms                              
#>   <dbl>      <dbl>     <dbl> <chr>                                  
#> 1     8       6.62     0.423 injury, function, cmybp, ...           
#> 2    10       6.81     0.339 mitochondrial, studies, plasticity, ...
#> 3     7      10.1      0.212 cancer, treatment, tumor, ...          
#> 4     4       9.28     0.171 cns, cell, cells, ...                  
#> 5     6      11.5      0.163 risk, factors, clinical, ...           
#> # … with 5 more rows
