...
summary <- tibble::as_tibble(data.frame(topic = 1, 
                                        prevalence = 1,
                                        coherence = 1,
                                        top_terms = "whee",
...
test_that("new_tidylda throws errors for wrong class inputs",{
  ...
  # class checks
  expect_error(new_tidylda(phi = 1, 
                           theta = theta, 
                           gamma = gamma, 
                           alpha = alpha, 
                           beta = beta, 
  ...
  expect_error(new_tidylda(phi = phi, 
                           theta = 1, 
                           gamma = gamma, 
                           alpha = alpha, 
                           beta = beta, 
...
test_that("new_tidylda throws errors for wrong dimension inputs", {
  ...
  expect_error(new_tidylda(phi = t(phi), 
                           theta = theta, 
                           gamma = gamma, 
                           alpha = alpha, 
                           beta = beta, 
